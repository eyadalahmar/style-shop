...
document.querySelector('#catagoriesm').style.setProperty('background-color','#813300')
   ...
   <div className={s.catagoriesm} id="catagoriesm"><Link to="/clothes" className={s.clothesm} id="clothesm"><Categories id='1' /></Link><div className={s.fmhorline} id="fmhor-line"></div><Link to="/shoes" className={s.shoesm} id="shoesm"><Categories id='4' /></Link><div className={s.smhorline} id="smhor-line"></div><Link to='/electronics' className={s.electronicsm} id="electronicsm"><Categories id='2' /></Link></div>:props.children=='langs'?
