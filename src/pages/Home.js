...
class Home extends Component{
  ...
  mount=()=>{
    ...
    document.querySelector('#arrow').style.setProperty('left',""+window.innerWidth/2+'px')
    ...
    if(!this.props.account)document.getElementById('langs').style.right="234px"
    else document.getElementById('lang').style.right="235px"
    
    }
    else{
      document.getElementById('rside').style.marginRight="0";
      if(!this.props.account)document.getElementById('langs').style.right="209px"
    ...
    const fcatagory = ReactDOM.createRoot(document.getElementById('fcatagory'));
    fcatagory.render(
      <React.StrictMode>
      1. <Categories id='1' />
      </React.StrictMode>
    );
    const scatagory = ReactDOM.createRoot(document.getElementById('scatagory'));
    scatagory.render(
      <React.StrictMode>
       <span>2. <Categories id='4' />
       </span></React.StrictMode>
    );
    const tcatagory = ReactDOM.createRoot(document.getElementById('tcatagory'));
    tcatagory.render(
      <React.StrictMode>
      3. <Categories id='2' />
      </React.StrictMode>
...
<div className={s.scrolls} id="scrolls"></div>  
  ...
  <div className={s.catagories} id="catagories">
    <div className={`${s.clothes} ${s.part}`}>
      <div className={`${s.clothes} ${s.title}`} id="fcatagory"></div>
...
<img className={`${s.simg} ${s.part}`} src={`${"https://picsum.photos/640/350?r="+Math.floor(Math.random()*1000000)}`} /> 
    ...
    <div className={`${s.shoes} ${s.title}`} id="scatagory"></div>
